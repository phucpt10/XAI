...
def write_frozen_dataset_artifacts(
    ...
    *,
    ...
    quarantine_decision_record: str,
    quarantine_registry_sha256: str,
    quarantine_summary_sha256: str,
    split_policy: str,
    seed: int,
) -> dict[str, str]:
    ...
    freeze_record = {
        ...
        "quarantine_decision_record": quarantine_decision_record,
        "quarantine_registry_sha256": quarantine_registry_sha256,
        "quarantine_summary_sha256": quarantine_summary_sha256,
